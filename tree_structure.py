...
def build_tree_for_org(org_id):
    ...
    attribute_types = Node(
        "attribute_types",
        parent=high_bond_root,
        url="/attribute_types?page[size]=500",
        api_response=pd.DataFrame,
        node_type="normal",
    )
    attribute_types_option = Node(
        "attribute_types_option",
        parent=attribute_types,
        url="",
        api_response=pd.DataFrame,
        node_type="nested",
        api_json_list=[],
        col_name_list=["type_options"],
    )
    ...
    handler_nested_structure = Node(
        "handler_nested_structure",
        parent=handlers,
        url="",
        api_response=pd.DataFrame,
        node_type="nested",
        api_json_list=[],
        col_name_list=["conditions", "actions", "triggers"],
    )
    ...
    records = Node("records", parent=record_types,url="/records",api_response=pd.DataFrame,node_type='normal')
    ...
    project_type_nested = Node(
        "project_types_nested_structure",
        parent=project_type,
        url="",
        api_response=pd.DataFrame,
        node_type="nested",
...
# high_bond_root=build_tree_for_org(31868)
